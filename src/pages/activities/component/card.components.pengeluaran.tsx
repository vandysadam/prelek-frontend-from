...
const CustomCardPengeluaran : React.FC<CustomCardProps> = ({ title, description, content, footer }) => {
    ...
    <Card>
      <CardHeader className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            className=" "
            to={`/activities/report-pengeluaran/${year}`}  // Gunakan Link untuk navigasi dinamis
          >
            Export
          </Link>
          </Button>
...
export default CustomCardPengeluaran;
